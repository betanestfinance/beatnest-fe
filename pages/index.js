  ...
  return (
    <div className="flex flex-col items-center justify-center font-sans overflow-x-hidden" style={{ fontFamily: "var(--font-family)" }}>
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          {[
            ...
            >
              ...
              <p className="text-[var(--color-warm-gray)] leading-relaxed">{item.desc}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      >
        ...
        <motion.p className="mb-8 text-lg">Take the first step toward building your legacy today.</motion.p>
        <a
            ...
            {testimonials.map((t, idx) => (
              ...
              >
                <div
                  ...
                  style={{ backgroundColor: "var(--color-cream)" }}
                >
                  <p className="italic text-[var(--color-warm-gray)] mb-4">"{t.text}"</p>
